    ...
    <div class="section-main sidebar-right">
      <div class="section-content">
        <aside class="sidebar-left">
          <div class="emo-tags-block">
            <h3 class="block-title">Эмо теги</h3>
          ...
          <div class="tags-list-block">
            ...
            <div class="block-content taxonomy">
        ...
        <div class="content-sidebar-left">
          <h2 class="title">Свинский рейтинг
          <div class="select-sort select-types">Сортировать <a href="#"><span>По дате</span></a>
            <div>
              <ul>
                <li data-value="date">По дате</li>
                <li data-value="relevant">По релевантности</li>
                <li data-value="name">По названию</li>
                <li data-value="random">По чему попало</li>
              </ul>
            </div>
          </div>
          </h2>
          <div class="tag-content">
            <article class="news teaser image clearfix">
              <div class="article-image">
                <a href="/"><img src="/content/blank.png" width="241" height="119"/></a>
              </div>
            ...
            <article class="news teaser">
              ...
              <h3 class="title"><a href="/">В Одессе на двух пляжах обнаружено загрязнение нефтепродуктами</a></h3>
            ...
            <article class="news teaser">
              ...
              <h3 class="title"><a href="/">В Одессе проходят дни украинского кино</a></h3>
